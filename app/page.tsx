      ...
      <section className="relative overflow-hidden bg-[var(--background)] pt-16 pb-0 md:pt-20">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 grid md:grid-cols-2 gap-12 items-end">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-[var(--foreground)] leading-[1.08] text-balance mb-6">
              {t("hero.heading")}
            </h1>
            ...
            <div className="flex flex-wrap gap-3">
              <motion.a
                ...
                whileTap={{ scale: 0.97 }}
                className="inline-flex items-center gap-2 bg-[var(--primary)] text-white px-7 py-3.5 rounded-full font-semibold text-sm shadow-[0_4px_20px_rgba(224,123,79,0.35)] hover:shadow-[0_6px_28px_rgba(224,123,79,0.45)] transition-all duration-300"
              >
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.03 }}
                whileTap={{ scale: 0.97 }}
                className="inline-flex items-center gap-2 border border-[var(--border)] text-[var(--foreground)] px-7 py-3.5 rounded-full font-semibold text-sm hover:bg-[var(--card)] transition-all duration-300"
              >
                {t("hero.scrollCta")}
              </motion.a>
            </div>
            ...
            <div className="mt-10 flex items-center gap-3">
              <div className="flex -space-x-2">
                {[1, 2, 3, 4].map((i) => (
                  <img
                    key={i}
                    src={"/images/avatar-pet-owner-" + i + ".jpg"}
                    alt=""
          ...
          >
            <div className="relative rounded-t-3xl overflow-hidden shadow-[0_-8px_48px_rgba(0,0,0,0.10)]">
              <img
                src="https://titoaistorageaccount.blob.core.windows.net/titoai-storage/site-images/7dd1bc8582254b7a8c51915fdcd414f8.webp"
                alt="A golden retriever resting on a linen cloud bed in a beautifully styled living room"
              ...
              <motion.div
                ...
                className="absolute top-6 left-6 bg-white/90 backdrop-blur-sm rounded-2xl px-4 py-3 shadow-[0_4px_20px_rgba(0,0,0,0.10)]"
              >
              ...
              {collections.map((col, i) => {
                ...
                return (
                  <motion.a
                    ...
                    className={"group relative rounded-2xl overflow-hidden " + colSpan + (isLarge ? " row-span-2" : "") + " block"}
                    style={{ minHeight: isLarge ? "480px" : "220px" }}
                  >
                    <img
                      src={col.image}
                      alt={col.title}
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            >
              {filteredProducts.map((product) => (
                <motion.div
                  ...
                  className="group bg-[var(--background)] rounded-2xl overflow-hidden border border-[var(--border)] shadow-[0_1px_2px_rgba(0,0,0,0.04),0_4px_16px_-4px_rgba(0,0,0,0.08)] hover:shadow-[0_4px_24px_-4px_rgba(0,0,0,0.14)] transition-all duration-300"
                >
            ...
            <div className="text-center mt-12">
              <motion.a
                ...
                whileHover={{ scale: 1.03 }}
                whileTap={{ scale: 0.97 }}
                className="inline-flex items-center gap-2 border-2 border-[var(--primary)] text-[var(--primary)] px-8 py-3.5 rounded-full font-semibold text-sm hover:bg-[var(--primary)] hover:text-white transition-all duration-300"
              >
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 grid md:grid-cols-2 gap-16 items-center">
            <div className="relative">
              <img
                ...
                alt="Pet360 founder with her dog in a beautifully designed home"
                className="rounded-3xl w-full h-[480px] object-cover shadow-[0_8px_48px_rgba(0,0,0,0.12)]"
              />
            ...
            <div>
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.03 }}
                whileTap={{ scale: 0.97 }}
                className="inline-flex items-center gap-2 bg-[var(--foreground)] text-white px-7 py-3.5 rounded-full font-semibold text-sm hover:opacity-85 transition-opacity"
              >
          ...
          <div className="max-w-2xl mx-auto px-6 text-center">
            ...
            {subscribed ? (
              <motion.div
                ...
                className="bg-[var(--card)] border border-[var(--border)] rounded-2xl px-6 py-5 text-[var(--foreground)] font-medium"
              >
              ...
              <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
                <input
                  ...
                  required
                  className="flex-1 px-5 py-3.5 rounded-full border border-[var(--border)] bg-[var(--card)] text-[var(--foreground)] placeholder:text-[var(--muted-foreground)] text-sm focus:outline-none focus:ring-2 focus:ring-[var(--primary)]/40"
                />
                <motion.button
                  type="submit"
                  whileHover={{ scale: 1.04 }}
                  whileTap={{ scale: 0.96 }}
                  className="bg-[var(--primary)] text-white px-6 py-3.5 rounded-full font-semibold text-sm whitespace-nowrap shadow-[0_4px_16px_rgba(224,123,79,0.3)] hover:shadow-[0_6px_24px_rgba(224,123,79,0.4)] transition-all duration-300"
                >
                  {t("newsletter.cta")}
                </motion.button>
              </form>
